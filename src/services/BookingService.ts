...
export class BookingService {
  ...
  public async approvePayment(id: number): Promise<void> {
    ...
    await this.notificationRepository.createNotification({
      ...
      detail: `Pembayaran tiket pesawat untuk rute ${booking.outbound_flight.origin_airport?.code} - ${booking.outbound_flight.destination_airport?.code} sudah dikonfirmasi. Siapkan perjalanan kamu dengan semangat!`,
